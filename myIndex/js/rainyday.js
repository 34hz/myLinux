...
function RainyDay(options, canvas) {
	...
	this.VARIABLE_GRAVITY_ANGLE=Math.random()+1;//生成1到2之间的随机数
	var defaults = {
		opacity: 1,
		blur: 20,
...
RainyDay.prototype.rain = function(presets, speed) {
	...
	this.PRIVATE_GRAVITY_FORCE_FACTOR_X = ((Math.PI / 2) - this.VARIABLE_GRAVITY_ANGLE) * (this.options.fps * 0.005) / 50;
